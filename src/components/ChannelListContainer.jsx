...
import PagerLogo from '../assets/p-logo.png'
    ...
    <div className="channel-list__sidebar">
        <div className="channel-list__sidebar__icon1">
            <div className="icon1__inner">
                <img src={PagerLogo} alt="Hospital" width="30" />
            </div>
        </div>
...
const Header = ({name, img}) => (
    <div className="channel-list__header">
        <Avatar image={img}/>
        <p className="channel-list__header__text">{'\t'}{name}</p>
    </div>
)
    ...
    return (
        <>
            ...
            <div className="channel-list__list__wrapper">
                <Header name={client.user.name} img={client.user.image}/>
